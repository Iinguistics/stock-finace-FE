...
const environmentFileContent = `
  ...
  export const environment = {
    ...
    YAHOO_FINANCE_API_HOST: '${process.env.YAHOO_FINANCE_API_HOST}',
    YAHOO_FINANCE_API_UUID: '${process.env.YAHOO_FINANCE_API_UUID}',
    YAHOO_FINANCE_API_USERID: '${process.env.YAHOO_FINANCE_API_USERID}',
  };
`;
